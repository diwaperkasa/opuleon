...
?>
    <div class="container">
        <div class="d-flex flex-row-reverse justify-content-center flex-wrap py-2 category-container mb-3">
            <?php $category = $term ?>
            <h1 class="m-0 p-0 fs-small"><a href="<?= get_term_link($category); ?>" class="text-decoration-none text-warning text-uppercase dm-sans fw-light tracking-wide"><?= $category->name ?></a></h1>
