            ...
            <article <?php post_class("py-4"); ?>>
                <div class="row">
                    <div class="col-md-8">
                        <div class="post__header">
                            ...
                            <header class="post__header border-bottom pb-4" role="heading">
                                ...
                                <?php if ($subtitle = get_the_subtitle(get_the_ID(), '', '', false)) : ?>
                                    <p class="text-secondary playfair-display fst-italic"><?= esc_html($subtitle) ?></p>
                                <?php endif; ?>
                        ...
                        <div class="post__featured post-featured-container">
                    ...
                    <div class="col-md-4">
                        <div class="sticky-top top-section">
                            <div class="border-bottom mb-3 mt-n3 pt-3">
                            ...
                            ?>
                            <ol class="ps-3">
                                <?php foreach ($popularPostIds as $idx => $postId): $post = get_post($postId); setup_postdata($post) ?>
                                    <li class="ps-2 text-warning fs-small <?= $idx ? "border-top" : "" ?>">
