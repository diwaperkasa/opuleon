<div class="card mb-3 border-0">
    ...
    <div class="card-body px-0">
        ...
        <a href="<?= get_the_permalink() ?>" class="text-decoration-none text-dark text-warning-hover">
            <h3 class="h4 card-title playfair-display fw-bold"><?php the_title() ?>
        ...
        <?php if ($subtitle = get_the_subtitle(get_the_ID(), '', '', false)) : ?>
            <p class="dm-sans d-none d-md-block"><?= esc_html($subtitle) ?></p>
        <?php endif; ?>
        <div class="d-flex flex-wrap dot-between-item">
            <?php $writers = get_the_terms(get_the_ID(), 'writer'); ?>
            <?php if ($writers): ?>
                <span class="fw-bold dm-sans fs-small d-none d-md-block">By
            ...
            <?php endif; ?>
            <span class="dm-sans fs-small d-none d-md-block"><?= get_the_date('j F Y'); ?></span>
