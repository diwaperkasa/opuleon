        ...
        <nav class="overflow-auto">
            <ul class="nav justify-content-between justify-content-md-center align-items-center flex-nowrap">
                ...
                <?php foreach ($menus as $menu): ?>
                    <li class="nav-item">
                        <a class="nav-link position-relative link-hover rounded-0 text-dark text-uppercase dm-sans mx-md-3 tracking-wide text-warning-hover <?= untrailingslashit( $menu['url'] ) === current_url() ? "link-active" : "" ?>" href="<?= $menu['url'] ?>"><?= $menu['title'] ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </nav>
