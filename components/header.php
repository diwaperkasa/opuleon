<div class="main-navbar">
    <nav class="navbar navbar-expand-lg align-items-center p-0 m-0 border-bottom">
        <div class="container">
            ...
            <a class="navbar-brand playfair-display fw-bold text-warning fs-1 tracking-wide m-0" href="/">
                <img height="30px" src="<?= get_stylesheet_directory_uri() . "/assets/icons/Opuleon Gold Logo.png" ?>" />
            </a>
        ...
        <nav class="overflow-auto">
            <ul class="nav justify-content-between justify-content-md-center align-items-center flex-nowrap">
                ...
                <?php foreach ($menus as $menu): ?>
                    <li class="nav-item">
                        <a class="nav-link position-relative link-hover rounded-0 text-dark text-uppercase dm-sans mx-3 tracking-wide text-warning-hover <?= get_permalink(get_queried_object_id()) ?> <?= $menu['url'] === get_permalink() ? "link-active" : "" ?>" href="<?= $menu['url'] ?>"><?= $menu['title'] ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </nav>
