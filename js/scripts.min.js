...
if (loadMoreBtn) {
  loadMoreBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var limit, page, args, term, res, articleContainer, className, _t;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            term = e.currentTarget.dataset.term;
            if (term) {
              args.term_id = term;
            }
            e.currentTarget.disabled = true;
            _context2.n = 1;
            return fetch("/wp-admin/admin-ajax.php?".concat(new URLSearchParams(args)), {
              headers: {
          ...
          case 2:
            ...
            e.currentTarget.dataset.page = (+page, _readOnlyError("page"));
            _context2.n = 4;
            break;
          case 3:
            _context2.p = 3;
