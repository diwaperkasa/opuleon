...
var subscribePopup = document.querySelector('.subscribe-popup-fixed');
if (subscribePopup) {
  ...
  var subscribeCloseBtn = document.querySelectorAll('.subscribe-close');
  subscribeCloseBtn.forEach(function (btn) {
...
document.documentElement.style.setProperty('--navbar-height', "".concat(header.offsetHeight - 1, "px"));
window.addEventListener('resize', function () {
  document.documentElement.style.setProperty('--navbar-height', "".concat(header.offsetHeight - 1, "px"));
});
var galleries = document.querySelectorAll('.gallery');
galleries.forEach(function (gallery) {
  var flkty = new (flickity__WEBPACK_IMPORTED_MODULE_2___default())(gallery, {
    cellAlign: 'center',
    freeScroll: false,
    wrapAround: true,
    autoPlay: true,
...
if (loadMoreBtn) {
  loadMoreBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var button, loader, limit, page, term, className, args, res, articleContainer, _t;
        ...
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 4:
            res.data.forEach(function (row) {
              articleContainer.insertAdjacentHTML('beforeend', "<div class=\"".concat(className, "\">").concat(row, "</div>"));
            });
...
searchBtn.forEach(function (btn) {
  btn.addEventListener('click', function () {
    ...
    var primaryBtn = document.querySelectorAll('.top-menu .nav-item:not(.cancel-box)');
    primaryBtn.forEach(function (btn) {
      btn.classList.toggle('d-none');
    });
    var closeBtn = document.querySelectorAll('.top-menu .cancel-box');
